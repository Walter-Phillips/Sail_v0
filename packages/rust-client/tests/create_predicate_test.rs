...
use fuels::{
    ...
    async fn test_predicate_creation() {
        ...
        let (predicate, _, _) = create_predicate::create_predicate("0x7895d0059c0d0c1de8de15795191a1c1d01cd970db75fa42e15dc96e051b5570".to_string(),"1_000_000".to_string(),"0u8".to_string(),&bech32_address,312332,123123,b256,b256,"123123".to_string());
