predicate;
    ...
    const SPENDING_SCRIPT_HASH = 38218392;
    // const MIN_GAS = 38218392;
    // the constants that define each predicate. I would rather pass these as arguments, but i dont know how 
    const OUTPUT_COIN_INDEX = 23;
    fn main(take_coin: b256, min_take_amount: u64, maker: b256) -> bool {
        // parameterize this thing
        let order = LimitOrder {
            maker: Address::from(38218392),
            maker_amount: 38218392,
            taker_amount: 38218392,
            maker_token: 23,
            taker_token: 38218392,
            salt: 38218392,
        };
    
        // handle cancellations
        let msg_sender = 38218392
        ////////////
        // INPUTS //
        ////////////
